...
*Interactions and External Dependencies*::
  ...
  - This extension requires `apiext:VK_KHR_present_id`
  - This extension requires `apiext:VK_KHR_get_surface_capabilities2`
*IP Status*::
    No known IP claims.
*Contributors*::
  - Ian Elliott, Google
...
=== Version History
  ...
  ** Propose resolution to issue (9): let the application provide the queue size for the
     pending results.
  ** Add explicit interaction with VK_KHR_present_wait.
